  ...
  return (
    ...
    >
      <div className="py-2 px-6 sm:px-10 w-full lg:w-3/4">
        ...
        <div className="nav3 flex flex-wrap mt-8 lg:mt-10 gap-4">
          <div className="nav3 inline-flex items-center gap-3 bg-black border border-black text-white uppercase rounded-[5px] px-5 py-3">
            ...
            <p className="text-xs whitespace-nowrap">book a discovery call</p>
          </div>
      ...
      <div className="relative w-full lg:w-[25vw] mt-12 lg:mt-0 flex justify-center">
        <div className="absolute lg:top-96 w-[70vw]  sm:w-[50vw] lg:w-full h-[40vw] sm:h-[30vw] lg:h-[15vw] overflow-hidden rounded-lg">
          <video
            src="/e22379bd.mp4"
            className="w-full h-full object-cover"
            autoPlay
        ...
        <h3 className="nav3 absolute top-[calc(40vw+2rem)] sm:top-[calc(50vw+2rem)] lg:top-[calc(24rem+15vw+1rem)]">
          showreel (2023-2025)
        </h3>
      </div>
    </div>
